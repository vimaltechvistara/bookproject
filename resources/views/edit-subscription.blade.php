            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                            <i class="fa fa-home position-left"></i> <span>Subscription Update</span></h4>
                    </div>
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body no-padding-bottom">
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Current Subscription Period</label>
                                    <div class="col-lg-8">
                                        2016-2017
                                    </div>
                                </div>
                            ...
                            <form class="form-horizontal" action="payment.php">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success" style="margin-left:400px">Buy Subscription</button>
