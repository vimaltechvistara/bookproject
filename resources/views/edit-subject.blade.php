            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                            <i class="fa fa-home position-left"></i> <span>Edit Subject</span></h4>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{{URL::to('/')}}/subjectlists"><button type="submit" class="btn btn-warning col-md-12" style="margin-bottom:10px;" >View All Subjects</button></a>
                                    </div>
                                    <div class="col-sm-2">
                                        <a href="{{URL::to('/')}}/createsubject"><button type="submit" class="btn btn-info col-md-12" style="margin-bottom:10px;">Add Multiple Subject</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body no-padding-bottom">
                                {!! Form::open( array( 'route' => array('updatesubject',$id) ,'role' => 'form' ,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal nobottommargin') ) !!}
                                   @foreach($subject as $sub)
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Subject</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Subject Name" name="subject_name" value="{{$sub->subject_name}}">
                                        </div>
                                    </div>
                                @endforeach()
                                    <div class="form-group">
