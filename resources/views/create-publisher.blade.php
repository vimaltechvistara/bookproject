            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                    <i class="fa fa-home position-left"></i> <span>Add New Publisher</span></h4>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{{URL::to('publisherlists')}}"><button type="submit" class="btn btn-warning col-md-12" style="margin-bottom:10px;" >View All Publisher</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body no-padding-bottom">
                                {!! Form::open( array( 'route' => array('savepublisher') ,'role' => 'form' ,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal nobottommargin') ) !!}
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Name of Publisher</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Name of the Publisher" name="publisher_name" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-2"><input type="text" class="form-control" placeholder="Pincode" name="pincode"></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Number of Students" name="no_of_institution">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-3"><input type="password" class="form-control" placeholder="Re-password" name="repassword"></div>
                                    </div>
                                    <div class="form-group ">
