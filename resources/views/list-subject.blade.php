            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                            <i class="fa fa-home position-left"></i> <span>List of Subject</span></h4>
                    </div>
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{{URL::to('/')}}/createsubject"><button type="submit" class="btn btn-warning col-md-12" style="margin-bottom:10px;" >Add Subject List</button></a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            <table id="example2" class="table table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{URL::to('/')}}/{{$sub->id}}/editsubject"><input type="button" value="Edit" class="btn btn-default"></a></td>
                                                </tr>
                                                    @endforeach
                                                </tbody>
                                                <div class="form-group">
