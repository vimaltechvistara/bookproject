            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                            <i class="fa fa-home position-left"></i> <span>Add New Class</span></h4>
                    </div>
                    <ul class="breadcrumb">
                        <li><a href=""><i class="fa fa-home"></i>Home</a></li>
                        <li class="active">Add Multiple Class</li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body no-padding-bottom">
                                {!! Form::open( array( 'route' => array('saveclass') ,'role' => 'form' ,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal nobottommargin') ) !!}
