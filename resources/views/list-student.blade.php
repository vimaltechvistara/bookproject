            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                            <i class="fa fa-home position-left"></i> <span>List of Students</span></h4>
                    </div>
                    <ul class="breadcrumb">
                    ...
                    <div class="col-md-12">
                      ...
                      @foreach($student as $stud)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{URL::to('/')}}/{{$stud->id}}/viewstudent"><input type="button" value="View" class="btn btn-default"></a>
                                                   <a href="{{URL::to('/')}}/{{$stud->id}}/editstudent"><input type="button" value="Edit" class="btn btn-default"></a>
                                                </td>
                                            </tr>
                                   @endforeach()
