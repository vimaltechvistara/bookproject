...
<div class="content-wrapper">
	...
	<div class="page-header">
		<div class="page-header-content">
			...
			<h4>
				<i class="fa fa-home position-left"></i> <span>View Student Profile</span></h4>
			</div>	
	...
	<div class="content">
		...
		<div class="row">
			...
			<div class="col-sm-2">
						<a href="{{URL::to('/')}}/studentlists"><button type="submit" class="btn btn-warning col-md-12" style="margin-bottom:10px;" >Add Student List</button></a>
                      
			</div>
			<div class="col-sm-2">
					  <a href="{{URL::to('/')}}/{{$id}}/editstudent"><button type="submit" class="btn btn-info col-md-12" style="margin-bottom:10px;">Edit Student Profile</button></a>
				...
				<div class="row">
							...
							<div class="form-group">
								<label class="control-label col-lg-4">Name of Student</label>
								<div class="col-lg-8">
									<div class=""> {{$stud->student_name}}</div>
								</div>
							</div>
